...
import { Task, CreateTaskPayload, PatchTaskPayload, RestorePayload } from '../types/task';
...
export const restoreTask = (id: string, payload: RestorePayload = {}) => client.post<{ run_id: string; message: string }>(`/tasks/${id}/restore`, payload).then(r => r.data);
